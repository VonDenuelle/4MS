	...
	<?php include_once '../php/global/sidenav.php'; ?>
		...
		<div class="container-fluid" style="width: calc(100% - 250px); margin-left: 250px;">
			<div class="row flex-nowrap">			
				<!-- 2ND COL -->
				<div class="col">
					<h1>Waiting For Customers to Receieve Orders</h1><hr>
				</div>
			</div>


			<a href="pending-orders" class="btn btn-outline-primary">Pending Orders</a>
			<a href="waiting-orders" class="btn btn-primary">Waiting Orders</a>
			...
			<?php
				  ...
				  WHERE o.status = "To Receive" ORDER BY o.date_added DESC';
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-muted">Date Accepted: 
                                <?php 
