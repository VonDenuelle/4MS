...
<div class="d-flex flex-column vh-100 flex-shrink-0 p-3 text-white" style="width: 250px;"><img class="logo" src="../images/4M's-Logo.png"><h3 class="mt-2">Admin</h3>
   ...
   <ul class="nav nav-pills flex-column mb-auto">
      <li> <a href="dashboard" class="nav-link text-white" aria-current="page"> <i class="fa fa-home"></i><span class="ms-2">Dashboard</span> </a> </li>
      <li> <a href="pending-orders" class="nav-link text-white"> <i class="fa fa-dashboard"></i><span class="ms-2">Orders</span> </a> </li>
   ...
   <hr>
   <a href="/4MS/logout" class="btn btn-danger">Logout</a>
</div>